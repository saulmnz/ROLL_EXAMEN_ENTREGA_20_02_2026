...
### CONGIGURACIÓN TABLERO 🔺

>[!NOTE]
>***EL TABLERO DE JUEGO ES UN OBJETO 3D `Plane` EL CUAL HE AUMENTADO SU ESCALA PARA QUE SEA MÁS GRANDE, PARA LAS PAREDES HE UTILIZADO CUBOS, APLICANDO LA MISMA LÓGICA ( AUMENTO DE ESCALA (EN TOTAL 4 CUBOS QUE HACEN EL RECINTO )) Y PARA LAS PAREDES EN MEDIO DEL CAMPO HE UTILIZADO CUBOS UTILIZANDO EL MISMO MÉTODO***

<img width="700" height="400" alt="image" src="https://github.com/user-attachments/assets/7584034b-832a-444e-937e-84a7bfd7352d" />
...
>[!NOTE]
> ***ES UN OBJETO 3D `Sphere`***

- ***SE LE ASIGNA EL TAG PLAYER EN EL INSPECTOR PARA IDENTIFICARLO EN LOS SCRIPTS***
...
>[!NOTE]
> ***CUANDO SE INICIA EL JUEGO TENEMOS EL OBJETIVO DE CONSEGUIR LA PUNTUACIÓN EN EL TIEMPO LÍMITE, PARA QUE ESTO LO SEPA EL USUARIO HE CONFIGURADO UN SCRIPT `GameManager` QUE LE DE LÓGICA AL JUEGO Y UNOS TEXTOS Y BOTONES (REINCIIAR) CANVA PARA MOSTRAR CUANDO SE PIERDE O GANA EL JUEGO.***
